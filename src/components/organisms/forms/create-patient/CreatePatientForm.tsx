import { DatePicker, Flex, Form, Input, Select, Upload } from "antd"
...
export const CreatePatientForm: React.FC<CreatePatientFormProps> = ({ form, onFinish }) => {
    const {
        normFile,
    } = useCreatePatientForm();
    return (
        <Content>
            <Form className="form" layout="vertical" form={form} onFinish={onFinish}>
